...
export default function InternalLayout({ children }) {
  ...
  const navItems = [
    ...
    {
      name: "Projects",
      path: createPageUrl("ProjectsManager"),
      icon: Building2
    },
    {
    ...
    },
    {
      ...
      path: createPageUrl("AISalesAssistant"),
      icon: Sparkles
    },
    {
      name: "Client Portal",
      path: getClientPortalUrl(createPageUrl("ClientPortal")),
      icon: Building2,
      external: true
    },
    {
    ...
    {
      name: "Proposals",
      path: createPageUrl("ProposalDashboard"),
      icon: FileText
    },
    {
      name: "Invoices",
      path: createPageUrl("InvoiceManagement"),
      icon: FileText
    },
    {
      name: "Admin Console",
      ...
      >
        ...
        <div className="p-4 border-t border-gray-700">
          <Button
            ...
            variant="outline"
            className="w-full mb-2 border-gray-400 text-white hover:bg-gray-300 hover:text-black-400 hover:border-white hidden lg:flex items-center justify-center"
